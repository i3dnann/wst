-- World Star Registry - HeidiSQL/MySQL/MariaDB schema
-- Import this file once into an empty database.
-- It creates the worldstar_wst database and all 27 application tables.
-- Administrator credentials are created later by the application seed command.

CREATE DATABASE IF NOT EXISTS `worldstar_wst`
...
-- Prisma migration history. This marks the baseline below as already applied so
-- future `prisma migrate deploy` commands only run newer migrations.
...
INSERT INTO `_prisma_migrations` (
    ...
    UUID(),
    '595744a5f180fc0e267a98f50fcfe7efd055e8d5da41dde3fe070bd223087fd4',
    CURRENT_TIMESTAMP(3),
    '0001_mysql_initial',
    1
);
...
CREATE TABLE `LiveStream` (
    ...
    `streamTitle` VARCHAR(500) NULL,
    `categoryName` VARCHAR(255) NULL,
    `liveStartedAt` DATETIME(3) NULL,
...
-- Import verification: this should return 27 application tables.
SELECT COUNT(*) AS `worldstar_application_table_count`
FROM `information_schema`.`TABLES`
WHERE `TABLE_SCHEMA` = 'worldstar_wst'
